...
def about_html():
    return (
        ...
        "<p>Bonus labs: a JPL-style porkchop plot of launch windows (C3 and "
        "delta-v contours) and a transfer study comparing Hohmann with "
        "Lambert costs - all rendered in interactive 3D via PyVista, with "
        "charts drawn by Matplotlib.</p>"
        "<table>"
